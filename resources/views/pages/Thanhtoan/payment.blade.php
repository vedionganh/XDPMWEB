            ...
            <div class="row">
                 <div class="col-sm-12 clearfix">
                        <div class="bill-to">
                            ...
                            <div class="form-one">
                                    Họ và tên:<input type="text" name="ten_ttkh" placeholder="Họ và tên" value=" {{ Session::get('tenkh') }}">

                                   Email: <input type="text" name="email_ttkh" placeholder="Email" value=" {{ Session::get('email') }}"   >

                                   Địa chỉ: <input type="text" name="diachi" placeholder="Địa chỉ">
                                  Số điện thoại:<input type="text" name="sdt_ttkh" placeholder="Phone" value="{{ Session::get('sdt') }}">
                                    Ghi chú:<textarea style="resize: none" cols="140"  rows="8" name="ghichu"  placeholder="Ghi chú đơn hàng " rows="16" ></textarea>
                            </div>
